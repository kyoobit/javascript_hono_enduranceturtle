...
app.get('/', (c) => {
    ...
    const data = {
        title: "Endurance Turtle",
        domain: "www.enduranceturtle.com",
        description: "Endurance Turtle: keep going, even at a turtle's pace.",
        word: "endurance\u00A0turtle",
        pronunciation: "enˈd(y)\u00F4rəns,\u00A0ˈtərdl",
        explanation: "keep going, even at a turtle's\u00A0pace.",
        meta: "Action: (noun)",
        css: {
          path: '/css/main.css',
